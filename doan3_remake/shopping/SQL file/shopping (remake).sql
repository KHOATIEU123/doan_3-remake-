...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 24, 2023 lúc 06:52 AM
...
(1, 'admin', '1', '2017-01-24 16:21:18', '21-06-2018 08:27:55 PM');
...
INSERT INTO `users` (`id`, `name`, `email`, `contactno`, `password`, `shippingAddress`, `shippingState`, `shippingCity`, `billingAddress`, `billingState`, `billingCity`, `regDate`, `updationDate`) VALUES
(1, 'khoa', 'khoa@gmail.com', 9009857868, '1', 'karachi,khi', 'Sindh', 'Sindh', 'Sindh area', 'Sindh area', 'SIndh', '2017-02-04 19:30:50', ''),
(2, 'tin ', 'tin@gmail.com', 8285703355, '1', '', '', '', '', '', '', '2017-03-15 17:21:22', ''),
(3, 'kk', 'kk@gmail.com', 1121312312, '1', '', '', '', '', '', '', '2018-04-29 09:30:32', '');
...
INSERT INTO `wishlist` (`id`, `userId`, `productsId`, `postingDate`) VALUES
...
--
-- Các ràng buộc cho bảng `ordertrackhistory`
--
ALTER TABLE `ordertrackhistory`
